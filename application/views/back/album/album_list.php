      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="box box-primary">
            <div class="box-body">
              <a href="<?php echo base_url('admin/') . strtolower($module) . '/create' ?>" class="btn btn-primary"><i
                    ...
                    foreach ($get_all as $data) { ?>
                      <tr>
                        ...
                        <td style="text-align: center"><img
                            src="<?php echo base_url('assets/images/album/') . $data->foto ?>" width="300px"></td>
                        ...
                        <td style="text-align: center">
                          <?php
                          echo anchor(site_url('admin/album/update/' . $data->id_album), '<i class="fa fa-pencil"></i>', 'title="Edit", class="btn btn-sm btn-warning"');
                          echo ' ';
