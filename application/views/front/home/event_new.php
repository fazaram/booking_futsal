...
<div class="row">
  <?php foreach ($event_new as $event) { ?>
      ...
      <div class="thumbnail">
        <a href="<?php echo base_url("event/$event->slug_event ") ?>">
          ...
          if (empty($event->foto)) {
            ...
            echo " <img src='" . base_url() . "assets/images/event/" . $event->foto . '_thumb' . $event->foto_type . "'> ";
          }
          ?>
        </a>
      </div>
    ...
    <div class="col-lg-8">
      <div class="caption">
        <h4><a
            href="<?php echo base_url("event/$event->slug_event ") ?>"><?php echo character_limiter($event->nama_event, 100) ?></a>
        </h4>
